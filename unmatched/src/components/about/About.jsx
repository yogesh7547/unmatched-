    ...
    return (
        <div className='w-[98%]  mx-auto flex flex-col px-2 mb-5 '>
            ...
            <div className='flex flex-col justify-evenly gap-5 md:flex md:justify-between md:flex-row'>
                <div className='w-[100%] h-[200px] bg-yellow drop-shadow-md flex flex-col items-center text-center py-3 px-2 md:max-h-[300px]'>
                    <Joystick />
                ...
                <div className='w-[100%] h-[200px] bg-blue drop-shadow-md flex flex-col items-center text-center py-3 px-2 md:max-h-[300px]'>
                    <MagicWand />
                ...
                <div className='w-[100%] h-[200px] bg-violet drop-shadow-md flex flex-col items-center text-center py-3 px-2 md:max-h-[300px]'>
                    <Padlock />
